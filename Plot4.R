...
#Convert Global_active_power/globalReactivePower/voltage/subMetering1-2-3 column data to number and store it in respective variable
...
#Set canvas to draw 2X2 i.e 2 Rows and 2 Columns
par(mfrow = c(2, 2)) 
